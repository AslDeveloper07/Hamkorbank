...
export const GridData = [
  ...
  {
    image: 'https://hamkorbank.uz/assets/images-cache/products/physical/popular-products/autoloan_xl.13c74c57.webP',
...
export const HamkorMobileData = [
  {
    ...
    mobileBankQR: 'Отсканируйте QR-код для быстрого доступа ко всем услугам банка'
  }
]